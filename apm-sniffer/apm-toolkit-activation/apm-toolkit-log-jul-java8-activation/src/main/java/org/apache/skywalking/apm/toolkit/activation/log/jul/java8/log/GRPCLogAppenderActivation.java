...
public class GRPCLogAppenderActivation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    public static final String INTERCEPT_CLASS =
            "org.apache.skywalking.apm.toolkit.activation.log.jul.java8.log.GRPCLogAppenderInterceptor";
    public static final String ENHANCE_CLASS =
            "org.apache.skywalking.apm.toolkit.log.jul.java8.log.GRPCLogClientHandler";
    public static final String ENHANCE_METHOD = "publish";
    ...
    public InstanceMethodsInterceptPoint[] getInstanceMethodsInterceptPoints() {
        if (!ToolkitConfig.Plugin.Toolkit.Log.TRANSMIT_FORMATTED) {
            LOGGER.warn("jul.java8 does not support transmitting un-formatted messages");
        }
